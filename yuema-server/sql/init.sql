...
CREATE TABLE IF NOT EXISTS rooms (
    ...
    start_window_begin DATETIME NULL DEFAULT NULL COMMENT '计划开始时间窗口起点',
    start_window_end DATETIME NULL DEFAULT NULL COMMENT '计划开始时间窗口终点',
    duration_minutes INT NULL DEFAULT NULL COMMENT '预计牌局时长(分钟)',
    base_score INT DEFAULT 1 COMMENT '底分',
    tai_fee INT DEFAULT 0 COMMENT '台费',
    longitude DECIMAL(10,7) DEFAULT NULL COMMENT '经度',
    latitude DECIMAL(10,7) DEFAULT NULL COMMENT '纬度',
    remark VARCHAR(255) DEFAULT NULL COMMENT '备注',
    game_rules TEXT DEFAULT NULL COMMENT '玩法细则(JSON，按玩法分桶)',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
